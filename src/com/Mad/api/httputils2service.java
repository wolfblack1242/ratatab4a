...
public class httputils2service extends android.content.BroadcastReceiver{
	...
	public void onReceive(android.content.Context context, android.content.Intent intent) {
        ...
        if (processBA == null) {
		    ...
		    processBA = new BA(context, null, null, anywheresoftware.b4a.BA.SharedProcessBA.ModuleType.RECEIVER, "com.Mad.api.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.Mad.api.httputils2service", processBA, _receiver, anywheresoftware.b4a.keywords.Common.Density);
		}
...
_job = (com.Mad.api.httpjob)(_taskidtojob.Get((Object)(_taskid)));
...
public static String  _submitjob(com.Mad.api.httpjob _job) throws Exception{
int _taskid = 0;
